...
$(function() {
   ...
   $('#excelupload').click(function(){
	/*   var imageURI = "file://localhost/var/mobile/Applications/EE97"
			 
	   window.plugins.FileUploader.uploadByUri("http://173.201.188.106:8080/img", imageURI, null, "file", "myimage", "image/jpg",
				   "uploadSuccess", "uploadFail", "uploadProgress");*/
				   
		    console.log("Excel upload in upload.js"+urlForServer);
	   excelopen();
   });
